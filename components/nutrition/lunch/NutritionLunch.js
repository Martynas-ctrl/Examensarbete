...
import NUTRITION_QUERY from './LunchQuery';
import Nutritionlunchinfo from './NutritionLunchInfo';
import Lunchinfo from './NutritionLunchInfo';
import AddLunch from '../lunch/AddNutritionLunch';
...
const consumedLunchCalories = Math.floor(totalscoresLunch / dailyIntakeForUser * 100);
...
const consumedProteinLunchInPercent = Math.floor(totalProtein / ProteinDailyNeed * 100);
const consumedCarbsLunchInPercent = Math.floor(totalCarbs / CarbsDailyNeed * 100);
const consumedFatLunchInPercent = Math.floor(totalFat / FatDailyNeed * 100);
     ...
     return (
        ...
        <AccordionDetails>
          ...
          <div className="container mt-4">
                ...
                <div style={{ width: 870 }}>
                  <h6>Daily Cosumed Calories {consumedLunchCalories} / {dailyIntakeForUser}</h6>
