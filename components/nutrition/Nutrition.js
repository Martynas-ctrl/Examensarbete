...
const consumedProteinBreakfast = Math.floor(totalProteins / ProteinDailyNeed * 100);
const consumedCarbsBreakfast = Math.floor(totalCarbss / CarbsDailyNeed * 100);
const consumedFatBreakfast = Math.floor(totalFats / FatDailyNeed * 100);

const consumedBreakfastCalories = Math.floor(totalscores / dailyIntakeprops * 100);
